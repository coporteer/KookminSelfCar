...
class LaneDetector():
    ...
    def __init__(self, width: int, height: int, canny_th1=60, canny_th2=75, 
                 roi_start_row=300, roi_end_row=600, margin=300, lane_interval=660):
        self.WIDTH, self.HEIGHT = width, height
        self.ROI_START_ROW = roi_start_row          # roi의 y 시작
        self.ROI_END_ROW = roi_end_row              # roi의 y 끝
        self.MARGIN = margin                        # 중앙 기준 차선을 찾지 않을 가로 px 너비의 반
    ...
    def do(self, img, display_img = False):
        ...
        # 2. Hough transfom
        all_lines = cv2.HoughLinesP(edge_img, 1, math.pi/180,10,10,20)    
        ...
        left_filtered_lines, right_filtered_lines = [], []
        left_b, right_b = [], []
